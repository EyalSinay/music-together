const navbarInfo = {
  title: {
    he: `על מה האתר הזה?`,
    ar: `ما هو موضوع هذا الموقع ؟`,
  },
  desc: {
    he: ` במדינה שלך, בעיר או בכפר שלך, יש כמה מוזיקאים שמנגנים מוזיקת ​​העם
    ...
    ar: `في بلدك أو مدينتك أو قريتك ، هناك بعض الموسيقيين الذين يعزفون
